...
<div class="big-container shadow">
    <div class="profile-sidebar">
        ...
        <div class="profile-nav">
            <ul>
                <li>
                    <a onclick='hideAll();document.getElementById("tab-overview").classList.remove("hidden")'>
                ...
                <li>
                    <a onclick='hideAll();document.getElementById("tab-planner").classList.remove("hidden")'>
                        <div class="nav-item">
                            <svg width="30" height="30" viewBox="0 0 24 24">
                ...
                <li>
                    <a onclick='hideAll(); document.getElementById("tab-achievements").classList.remove("hidden")'>
                        <div class="nav-item">
                            <svg width="30" height="30" viewBox="0 0 24 24">
                ...
                <li>
                    <a onclick='hideAll();document.getElementById("tab-goals").classList.remove("hidden")'>
                        <div class="nav-item">
                            <svg width="30" height="30" viewBox="0 0 24 24">
